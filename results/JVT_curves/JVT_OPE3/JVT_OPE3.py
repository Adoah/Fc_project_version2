...
data =pd.read_csv('JVT_OPE3.txt', delimiter = '\t',header=None)  
...
for col in cols:
    ...
    Temp=[0,300,290,280,270,360,250,240,230,220,210,200,180,150] 
...
plt.ylabel("|J|(A/cm^2)")   
plt.title("Temperature depent_OPE3")
plt.savefig("JVT_OPE3.png")    
plt.legend() 
plt.show()
