...
data =pd.read_csv('JVT_OPE1.txt', delimiter = '\t',header=None)  
...
for col in cols:
    ...
    Temp=[0,270,260,250,240,230,220,210,200,190,180] 
...
plt.ylabel("|J|(A/cm^2)")   
plt.title("Temperature depent_OPE1")
plt.savefig("JVT_OPE1.png")    
plt.legend() 
plt.show()
