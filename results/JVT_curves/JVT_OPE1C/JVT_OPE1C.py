...
data =pd.read_csv('JVT_OPE1C.txt', delimiter = '\t',header=None)  
...
for col in cols:
    ...
    Temp=[0,300,290,280,270,260,250,240]  
...
plt.ylabel("|J|(A/cm^2)")   
plt.title("Temp dependent of OPEnC")
plt.savefig("JVT_OPE1C_fit_All.png")    
plt.legend() 
plt.show()
