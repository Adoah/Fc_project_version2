...
fL = 'C:\Users\Ziyu\OneDrive - National University of Singapore\Research\Data\J-V\OPE1CSH\'; % This string should be the directory address to the text file
...
files = dir(strcat(fL,'*.txt'));

%for i = 1:length(files)
%    [a2,a1] = readIn(fL,cellstr(files(i).name));
%    a{i} = a2;
%    mi(i) = min(a2{7});
%    ma(i) = max(a2{7});
%end
...
%f = cellstr({f1});
f = cellstr({f1;f2;f3;f4;f5;f6;f7;f8;f9;f10;f11;f12;f13;f14;f15;f16;f17;f18;f19;f20;f21;f22;f23;f24});
%%MATLAB2016

%v = [-0.5, -0.4, -0.3];
% Plotting (0 = no plot of each gaussian, 1 = plots)
yesPlot = 0;
[twotrace,onetrace] = readIn(fL,f,yesPlot); % Execute readIn script, return single and double trace data
